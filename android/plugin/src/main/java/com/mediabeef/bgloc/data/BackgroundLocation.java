...
//        configDAO = DAOFactory.createConfigurationDAO(getApplication().getApplicationContext());
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(is_end_of_trip?1:0);
     ...
     * @param batchStartMillis batch run time in milliseconds
     */
     ...
     *
     * @param elapsedRealtimeNanos time elapsed real-time of fix, in nanoseconds since system boot.
     */
